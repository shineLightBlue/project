  ...
  <div class="step-body">
    ...
    >
      ...
      <el-form-item label="资格证书：" prop="teacherCertImg">
        <el-tabs v-model="certIndex">
          ...
          <el-tab-pane label="高学历证" name="1">
            <common-entering-step2-upload-image :imageUrl.sync="form.eduCertImg"
      ...
      <el-form-item label="证书编号：" prop="teacherCertNo">
        ...
        <el-input
          v-show="certIndex === '1'"
          v-model="form.eduCertNo"
          placeholder="请填写证书编号"
        ></el-input>
        <el-input
          v-show="certIndex === '2'"
          v-model="form.majorCertNo"
          placeholder="请填写证书编号"
        ></el-input>
      </el-form-item>
    </el-form>
    ...
    >
      ...
      <el-form-item label="主营类目：" prop="mainCategory">
        <common-entering-step2-main-category
          :mainCategory.sync="form.mainCategory"
        />
      </el-form-item>
